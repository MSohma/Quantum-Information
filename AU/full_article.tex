...
\section{Representation on $\cal{H}\otimes\cal{H}$}
 ...
 We identify the Hilbert-Schmidt space $\mathfrak{H}_2(=\mathfrak{N}=M_n(\mathbb{C})=\mathfrak{B}({\cal H}))$ on ${\cal H}=\mathbb{C}^n$ with $\cal{H}\otimes\cal{H}$
...
the cyclic and separating vector $\rho^{1/2}$, we get
